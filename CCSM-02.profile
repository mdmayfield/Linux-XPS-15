...
s0_highlight_color = #ffffffd0
s0_highlight_border_color = #000000ff
...
s0_screen_toggle_key = <Shift><Super>n
s0_neg_match = any
...
[core]
s0_active_plugins = core;composite;crashhandler;opengl;decor;copytex;commands;place;compiztoolbox;resize;snap;wall;matecompat;neg;session;vpswitch;mousepoll;grid;imgpng;regex;move;animation;thumbnail;expo;ezoom;staticswitcher;fade;scale;
...
s0_initiate_edge = 
s0_initiate_key = <Super>grave
s0_initiate_button = Disabled
s0_initiate_all_edge = 
s0_initiate_all_button = Disabled
s0_initiate_all_key = <Shift><Super>asciitilde
