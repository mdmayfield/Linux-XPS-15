...
[core]
s0_active_plugins = core;composite;crashhandler;opengl;workspacenames;compiztoolbox;copytex;decor;extrawm;grid;imgpng;matecompat;mousepoll;move;neg;place;regex;resize;session;snap;thumbnail;vpswitch;wall;animation;commands;expo;ezoom;staticswitcher;fade;scale;
...
s0_toggle_fullscreen_key = <Control>F11
...
s0_prev_key = Disabled
s0_prev_button = Disabled
s0_left_window_key = <Shift><Control><Super>Left
s0_right_window_key = <Shift><Control><Super>Right
s0_up_window_key = <Shift><Control><Super>Up
s0_down_window_key = <Shift><Control><Super>Down
s0_flip_left_edge = 
s0_flip_right_edge = 
s0_flip_up_edge = 
s0_flip_down_edge = 
